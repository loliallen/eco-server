...
from src.controllers.product.transaction_user import TransactionController
...
api = Api(app, title="EcoApi for User", authorizations={ "JWT": {"type": "http", "scheme": "bearer", "bearerFormat": "JWT"}})
...
api.add_resource(TransactionController, '/api/transaction')
