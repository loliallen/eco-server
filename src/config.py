...
class Configuration:
    ...
    JWT_ACCESS_TOKEN_EXPIRES = datetime.timedelta(hours=int(os.getenv("JWT_ACCESS_TOKEN_EXPIRES", default=2)))
    JWT_ADMIN_ACCESS_TOKEN_EXPIRES = datetime.timedelta(hours=int(os.getenv("JWT_ADMIN_ACCESS_TOKEN_EXPIRES", default=2)))
    JWT_TOKEN_LOCATION = 'headers'
    PROPAGATE_EXCEPTIONS = True

    RECOVERY_TOKEN_EXPIRES = datetime.timedelta(seconds=int(os.getenv("RECOVERY_TOKEN_EXPIRES", default=120)))
    ...
    DB_TIMEOUT = int(os.getenv("DB_TIMEOUT", default=5000))
    ...
    ECO_COINS_BY_INVITE = int(os.getenv("ECO_COINS_BY_INVITE", default=15))
    ECO_COINS_BY_OFFER_NEW_REC_POINT = int(os.getenv("ECO_COINS_BY_OFFER_NEW_REC_POINT", default=30))
    ECO_COINS_BY_OFFER_CHANGE_REC_POINT = int(os.getenv("ECO_COINS_BY_OFFER_CHANGE_REC_POINT", default=20))

    WEIGHT_RECYCLE_TO_NEED_APPROVE = int(os.getenv("WEIGHT_RECYCLE_TO_NEED_APPROVE", default=15))
    TEST_FREEZE_TIME = datetime.timedelta(days=int(os.getenv("TEST_FREEZE_TIME", default=1)))
    MAX_RADIUS_REC_POINTS_SHOW = int(os.getenv("MAX_RADIUS_REC_POINTS_SHOW", default=100))
